...
const CartInfo = () => {
    ...
    const openEditModal = (item) => {
        ...
        setEditItem({ ...item, quantity: Number(item.quantity) }); // ensure quantity is number
        setModalType("edit");
        setModalOpen(true);
    ...
    const confirmOrder = (id) => {
        ...
        toast.success(`Order confirmed for ${editItem.name}!`);
    ...
    const updateItem = () => {
        ...
        // console.log(tempt)
        setCartItems(tempt);
        localStorage.setItem("cartItems", JSON.stringify(tempt));
        setModalOpen(false);
        ...
        <div className="w-[95%] mx-auto">
            ...
            {cartItems.length === 0 ? (
                ...
                <div className=" overflow-x-auto">
                                    ...
                                    >
                                        ...
                                        <td className="flex gap-2 w-fit mx-auto" align="middle">
                                            ...
                                            <button
                                                ...
                                                onClick={() => confirmDelete(item.id, item.color, item.size)}
                                            >
                                                Delete
                                            </button>
                                            <button
                    ...
                    <div className="block md:hidden lg:hidden ">
                        {cartItems.map((item, idx) => (
                            <div className="card card-side bg-base-100 shadow-sm max-h-48 w-full mb-4 ">
            ...
            {modalOpen && editItem && modalType === "edit" && (
                <dialog id="edit_modal" className="modal modal-open">
                    <form method="dialog" className="modal-box max-w-md" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <input type="text" value={editItem.name} className="input input-bordered w-full" disabled />
                            </div>
            ...
            {orderModalOpen && editItem && modalType === "order" && (
                <div className="modal modal-open">
                    <div className="modal-box max-w-lg">
                        ...
                        <p> <strong>Price:</strong> {editItem.price}
                            <span style={{ fontFamily: "'Noto Sans Bengali', sans-serif" }}>৳</span></p>
                        {/* User Info */}
                        ...
                        <div className="modal-action">
                            <button className="btn" onClick={() => setOrderModalOpen(false)}>
                                Cancel
                            </button>
                            <button className="btn btn-primary" onClick={()=>confirmOrder(editItem.id)}>
                                Confirm Order
                            </button>
                        </div>
                    </div>
